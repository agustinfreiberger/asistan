...
public class MyPlacesMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private void setPlaces(@NotNull MutableLiveData<ArrayList<Place>> places) {
        ...
        this.observer = new Observer<ArrayList<Place>>() {
            ...
            public void onChanged(@Nullable ArrayList<Place> places) {
                if (places != null) {
                    MyPlacesMapFragment.this.refreshMap(places);
                }
            }
        };
    }

    public static MyPlacesMapFragment newInstance(@NotNull MutableLiveData<ArrayList<Place>> places) {
        MyPlacesMapFragment fragment = new MyPlacesMapFragment();
