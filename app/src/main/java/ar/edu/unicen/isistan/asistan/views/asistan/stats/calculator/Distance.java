...
public class Distance extends StatsCalculator {
    ...
    public Distance(String modeDescription, TransportMode... transportMode) {
        this.description = "Distancia recorrida " + modeDescription.toLowerCase();
